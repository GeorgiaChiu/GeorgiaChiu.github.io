...
var exampleImageUrlMap = {
    "1": {
        "1": "/resourse/classic /basic01.jpg",
        "2": "/resourse/classic /basic02.jpg",
...
var colorMap= {
    ...
    "4": {
        "1": "先請跳過這部分，飾品細節我會再與妳聯繫",
        "2": "先請跳過這部分，飾品細節我會再與妳聯繫" ,
        "3": "妳可以選擇 2 種棉線 1 種花線",
        "4": "妳可以選擇 1 種毛線 1 種花線",
        "5": "請跳過這部分",
        "6": "請跳過這部分",
...
function render() {
    ...
    if(state.number_confirmed){
        ...
        document.getElementById("showtext").innerHTML = "請選擇上面編號";
    }
    if(state.upup_confirmed){
        document.getElementById("showprice").innerHTML = priceMap [formData.get('bigtype')][formData.get('number')] + 120;
    }
    else{
